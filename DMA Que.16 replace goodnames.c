/* Que.16 C program to replace goodnames in mail.
...
{
	char ch;
	int i=0 ,num_of_char=1 , j;//num of char is 1 cause there is we have already inserted one character \0 in 0th index
